...
unityPosition = [200,700] # position in the drawing area where unity (1) should be
...
stepLength = 3 # step length along Collatz path
...
while running == True:
	...
	if finishedDrawing == False:
		...
		for eachPath in collatzPaths:
			...
			lineColour = [randint(lineColourLBound[0], lineColourUBound[0]),
